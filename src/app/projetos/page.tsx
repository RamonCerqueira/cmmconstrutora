...
import { MapPin, Layers, Calendar, ArrowRight, ShieldCheck, User } from 'lucide-react';
          ...
          {filters.map((filter) => {
            ...
            return (
              <button
                ...
                className={`px-5 py-3 rounded-full text-xs sm:text-sm font-semibold tracking-wide transition-all duration-300 focus:outline-none ${
                  isActive
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 border-t border-gray-50 pt-4 text-xs font-sans text-gray-500">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="truncate">{project.client.split('/')[0]}</span>
                      </div>
                      <div className="flex items-center gap-2">
